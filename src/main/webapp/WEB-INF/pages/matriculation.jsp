...
<t:pageTemplate pageTitle="Matriculation">
    ...
    <form class="form-matriculation" method="POST" action="">
        ...
        <div class="row mb-2">
            ...
            <div class="col-md mr-3 text-left">
                <input type="number" id="homeAddressCounty" name="homeAddressCounty" class="form-control" required autofocus>
            </div>
        </div>
        <div class="row mb-2">
            <div class="col-md-3">
            ...
            <div class="col-md mr-3 text-left">
                <input type="number" id="homeAddressCity" name="homeAddressCity" class="form-control" required autofocus>
            </div>
        </div>
        <div class="row mb-2">
            <div class="col-md-3">
        ...
        <div class="row mb-2">
            ...
            <div class="col-md mr-3 text-left">
                <input type="text" id="placeOfBirthCountry" class="form-control" required autofocus>
            </div>
        </div>
        <div class="row mb-2">
            <div class="col-md-3">
        ...
        <div class="row mb-2">
            ...
            <div class="col-md mr-3 text-left">
                <input type="text" id="preuniversitarStudiesLength" name="preuniversitarStudiesLength" class="form-control" required autofocus>
            </div>
        </div>
        <div class="row mb-2">
            <div class="col-md-3">
            ...
            <div class="col-md mr-3 text-left">
                <input type="text" id="preuniversitarStudiesGraduationYear" name="preuniversitarStudiesGraduationYear" class="form-control" required autofocus>
            </div>
        </div>
        <div class="row mb-2">
            <div class="col-md-3">
            ...
            <div class="col-md mr-3 text-left">
                <select class="form-control" id="preuniversitarStudiesType" name="preuniversitarStudiesType">
                    ...
                    <option value="">Invatamant la distanta</option>
                </select>
            </div>
        </div>
        ...
        <div class="row mb-2">
            ...
            <div class="col-md mr-3 text-left">
                <input type="text" id="bacDiplomaReleaseDateYear" name="bacDiplomaReleaseDateYear" class="form-control" required autofocus>
            </div>
        </div>
        <hr>
